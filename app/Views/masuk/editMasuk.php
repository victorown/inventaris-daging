...
<div class="row">
  <form action="/updateMasuk/<?= $masuk->id ?>" method="POST" enctype="multipart/form-data">
    <?= csrf_field(); ?>
    ...
    <div class="card px-3 py-2">
      ...
      <div class="form-group">
        ...
        <div class="input-group">
          <textarea class="form-control" aria-label="With textarea" name="jumlah"><?= $masuk->jumlah ?></textarea>
        </div>
      </div>
      ...
      <div class="form-group mb-3">
        ...
        <div class="input-group">
          <input type="date" class="form-control" id="basic-url" aria-describedby="basic-addon3" value="<?= $masuk->tanggal ?>" name="tanggal">
        </div>
      </div>
      <div class="row">
        <div class="col">
